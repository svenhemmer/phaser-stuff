...
export class TipPrompt {
    constructor(_doc, type) {
        ...
        switch (type) {
            ...
            case "instrumentType":
                {
                    message = div(h2("Instrument Type"), p("BeepBox comes with many instrument presets, try them out! You can also create your own custom instruments!"), p("There are also options for copying and pasting instrument settings and for generating random instruments at the top of the instrument type menu."));
                }
                break;
            case "eqFilter":
                {
            ...
            case "chipWave":
                {
                    message = div(h2("Chip Wave"), p("BeepBox comes with some sound waves based on classic electronic sound chips, as well as several unique waves. This is the basic source of the sound of the instrument, which is modified by the other instrument settings."));
                }
                break;
            case "chipNoise":
                {
            ...
            case "effects":
                {
                    message = div(h2("Effects"), p("BeepBox has many different kinds of special effects you can add to instruments. You can turn on multiple effects at once, and they can be configured individually. Try them all out!"));
                }
                break;
...
//# sourceMappingURL=TipPrompt.js.map